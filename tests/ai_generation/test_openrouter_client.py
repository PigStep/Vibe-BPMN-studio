...
from src.ai_generation.llm_clients import OpenRouterClient
...
def test_generate_text_response_basic(openai_client):
    ...
    openai_client.client.chat.completions.create.return_value = response

    result = openai_client.generate_response_text_based(
    ...
    _, kwargs = openai_client.client.chat.completions.create.call_args
...
def test_generate_response_json_structure(openai_client):
    ...
    result = openai_client.generate_response_json_based(
